            ...
            <MaxWidthContainer>
              <div className="px-24 py-14 bg-neutral-100 h-full">
                ...
                <p className="mb-6">
                  ...
                  when you visit a website. They are widely used to make the
                  browsing experience more efficient and to provide information
                  to the site owners.
                </p>
                ...
                <ul className="list-disc ml-6 mb-6">
                  <li className="mt-2">
                    Necessary Cookies: Essential for the operation of the site
                    and allow you to navigate and use its core functions.
                  </li>
                  <li className="mt-2">
                  ...
                  <li className="mt-2">
                    ...
                    with the site, providing anonymous usage information and
                    helping us improve.
                  </li>
                </ul>
                ...
                <p className="mb-6">
                  ...
                  media and analytics services, may use their third-party
                  cookies. We have no control over these cookies and recommend
                  checking the privacy policies of third-party services.
                </p>
