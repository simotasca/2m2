        ...
        <section className="bg-[#363636]">
          <MaxWidthContainer>
            <div className="px-24 py-14 bg-neutral-100 h-full">
              ...
              <p className="mb-6">
                Welcome to 2M2 Ricambi. Before using our site, we invite you to
              ...
              <p className="mb-6">
                ...
                "our" on the site refer to 2M2 Ricambi. 2M2 Ricambi provides you
                with this website, including all information, tools, and
                ...
                new features or tools added to the current store shall also be
              ...
              <p className="mb-6">
                ...
                without consulting more accurate, complete or timely sources of
              ...
              <h2 className="text-2xl font-bold mb-3">Products or Services</h2>
              <p className="mb-6">
                Certain products or services may be available exclusively online
                through the website. These products or services may have limited
                quantities. We have made every effort to display as accurately
                as possible the colors and images of our products that appear at
                the store. We cannot guarantee that your computer monitor's
                display of any color will be accurate. We reserve the right, but
                are not obligated, to limit the sales of our products or
              ...
              <p className="mb-6">
                ...
                or participate in any unlawful acts; (c) to violate
                ...
                orientation, religion, ethnicity, age, national origin, or
                ...
                functionality or operation of the Service, other websites, or
                the Internet; (h) to collect or track the personal information
              ...
              <p className="mb-6">
                ...
                we may remove the service for indefinite periods of time or
                ...
                and non-infringement. In no case shall 2M2 Ricambi and its
                ...
                the services or any products procured using the service, or for
              ...
              <p className="mb-6">
                ...
                using our site. Additionally, if, in our sole judgment, you
